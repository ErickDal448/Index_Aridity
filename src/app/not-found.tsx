  ...
  return (
    <div className="bg-foreground items-center justify-items-center w-full h-full min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="fixed top-[50%] left-[50%] translate-y-[-50%] translate-x-[-50%] flex flex-col items-center justify-center bg-background w-[80vw] h-[75vh] md:w-[40vw] md:h-[70vh] rounded-[60px] z-[9999] shadow-xl animate-home">
        {isClient && ( // Renderiza motion.div solo en el cliente
          <motion.div
            className="bg-background fixed top-[20%] left-[50%] translate-y-[-50%] translate-x-[-50%] rounded-xl flex items-center justify-center min-w-fit min-h-fit w-full z-[99999]"
            variants={fitTitle}
            initial="start"
            animate="end"
        ...
        {isClient && ( // Renderiza motion.ul solo en el cliente
          <motion.ul
          ...
          >
            <div className="flex items-center text-2xl gap-x-2 bg-bghover rounded-full p-3 text-foreground hover:text-primary hover:bg-backprimary">
              <Link href="/" className={`flex items-center w-full hover:text-primary`} prefetch={false}>
